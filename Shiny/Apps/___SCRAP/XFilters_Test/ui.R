         ...
         tabsetPanel(
            ...
            tabPanel(
               ...
               checkboxInput( inputId = "display_data",
                              ...
                              value = FALSE ),
               br(),
               actionButton(inputId = "activate_data_display", label = "Activate data display now"),
               br(), br(),
            ...
            tabPanel(
               ...
               checkboxInput( inputId = "display_sumstats",
                              ...
                              value = FALSE ),
               br(),
               actionButton(inputId = "calculate_sumstats", label = "Calculate summary statistics now"),
               br(), br(),
            ...
            tabPanel(
               ...
               # textOutput("str_filter_obs"),
               # br(),
               # textOutput("str_obsfilters"),
               # br(),
               # textOutput("str_filter_value"),
               # br(),
               # textOutput("str_dat2"),
               # br(),
               # textOutput("str_dat3"),
